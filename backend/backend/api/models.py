...
class personal(models.Model):
	...
	Personal_page=models.URLField(max_length=100)
...
class conference(models.Model):
	...
	Support=models.CharField('If its open access, Whether Support received from Vellore Institute of Technology?',max_length=4,choices=jy, blank=True,null=True)
...
class book_chapter(models.Model):
	...
	Funder_name=models.CharField('Enter Funder name if type is "Open" ',max_length=100,blank=True)
	Amount_of_Publication=models.IntegerField('Enter Amount of Publication if type is "Open" ',blank=True, null=True)
	Support=models.CharField('If its open access, Whether Support received from Vellore Institute of Technology?',max_length=4,choices=jy,null=True)
...
class book_editor(models.Model):
	...
	Emp_ID=models.ForeignKey(personal,null=True,on_delete=models.SET_NULL)
	Type_of_publication=models.CharField(max_length=100, choices=TP)
	Funder_name=models.CharField('Enter Funder_name if type is "Open" ',max_length=100,blank=True)
	Amount_of_Publication=models.IntegerField('Enter Amount_of_Publication if type is "Open" ',blank=True, null=True)
	Support=models.CharField('if it open access, Whether Support received from Vellore Institute of Technology?',max_length=4,choices=jy,null=True)
