    ...
    return (
        <div className="d-flex justify-content-center">
            <form className="form justify-content-center" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="input-container ic1">
                    <input id="ORCID_ID" className="input" type="text" placeholder=" " {...register("ORCID_ID")}/>
                    <div className="cut" />
                ...
                <div className="input-container ic1">
                    <input id="rgate" className="input" type="text" placeholder=" " {...register("Researchgate")}/>
                    <div className="cut" />
                ...
                <div className="input-container ic1">
                    <input id="link" className="input" type="text" placeholder=" " {...register("linkedin")}/>
                    <div className="cut" />
                ...
                <div className="input-container ic1">
                    <input id="gscholar" className="input" type="text" placeholder=" " {...register("Google_scholar_name")}/>
                    <div className="cut" />
                ...
                <div className="input-container ic1">
                    <input id="personal" className="input" type="text" placeholder=" " {...register("Personal_page")}/>
                    <div className="cut" />
