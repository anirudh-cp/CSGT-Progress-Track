...
urlpatterns = [
    ...
    path('actions/<date:startDate>/<date:endDate>/<path:data>',
         ActionsReportApiView.as_view()),
    path('actions/users', ActionsUsersApiView.as_view()),
    path('actions/users/delete', ActionsUserDeletesApiView.as_view()),
    ...
    path('data/<int:emp_id>/<Type>/<date:startDate>/<date:endDate>',
         DataSingleGetApiView.as_view()),
